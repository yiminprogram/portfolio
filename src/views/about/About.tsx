  ...
  return (
    <AboutDiv>
      ...
      <Introduce>
        ...
        <p>
          您好，我叫<Name>陳毅旻</Name>
          ，近期於資策會應用程式設計師就業養成班經過636小時的專業訓練，研習期滿並經考試及格，結訓專案網站負責的內容範圍包含利用HTML、CSS以及Javascript進行前端設計，後利用C#進行後端資料存取。自我鑽研React以及Vue前端技術，並利用React以及Vue製作出一些小型的網站作品以及網站元件。
        </p>
      </Introduce>
      <Skill ref={target}>
        {data.map((ele) => (
